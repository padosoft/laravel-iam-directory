...
use Padosoft\Iam\Directory\IamDirectoryServiceProvider;
use Padosoft\Iam\IamServiceProvider;

abstract class TestCase extends Orchestra
{
    /**
     * The directory module is tested together with the server package (its in-process PDP,
     * Grant/Membership/User/Organization models and migrations), resolved from Packagist as a dev dependency.
     *
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            IamDirectoryServiceProvider::class,
        ];
    }
